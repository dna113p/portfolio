...
class App extends Component {
  constructor(props) {
    ...
    var badUserAgents = /Firefox/;
    let excludeMe = badUserAgents.test(navigator.userAgent) && !window.MSStream;

    this.state = {
      winHeight: window.innerHeight,
      fixNav: false,
      no3d: excludeMe | this.mobileCheck()
    };
